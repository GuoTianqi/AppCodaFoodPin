...
//  FoodPin
//
//  Created by GuoTianqi on 15/7/14.
...
class PageViewController: UIPageViewController, UIPageViewControllerDataSource {
    ...
    var pageSubHeadings = ["Pin your favourite restaurants and create your own food guide",
    ...
    func viewControllerAtIndex(index: Int) -> UIViewController? {
        ...
        if let pageContentViewController = storyboard?.instantiateViewControllerWithIdentifier("PageContentViewController")
